...
- [Live Demo](http://localhost:4200/data-view)
...
| DataView | Template-driven list/grid rendering with built-in paginator and external sort hooks | 3 | - | 3 (`sm`/`md`/`lg`) | ✅ Complete |
