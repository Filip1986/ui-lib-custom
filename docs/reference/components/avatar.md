...
| `--uilib-avatar-mount-animation` | `uilib-avatar-mount 0.15s cubic-bezier(0.4, 0, 0.2, 1) both` |
| `--uilib-avatar-radius`          | `var(--uilib-radius-full, 9999px)`                           |
