...
| `ariaLabel`            | `string`                                                  | `''`                                            | Accessible label for the scrollable region.                                                                                                                                                                                         |
| `availableItemsText`   | `string`                                                  | `'item(s`                                       | Localizable suffix appended after the announced total item count.                                                                                                                                                                   |
...
| `defaultGridAriaLabel` | `string`                                                  | `'Scrollable grid'`                             | Default fallback label used when no explicit grid ariaLabel is provided.                                                                                                                                                            |
| `defaultListAriaLabel` | `string`                                                  | `'Scrollable list'`                             | Default fallback label used when no explicit list ariaLabel is provided.                                                                                                                                                            |
...
| `emptyMessage`         | `string`                                                  | `'No items to display.'`                        | Localizable message announced when the data set is empty.                                                                                                                                                                           |
...
| `loadingMessage`       | `string`                                                  | `'Loading items…'`                              | Localizable message announced while the first batch is loading.                                                                                                                                                                     |
| `loadingMoreMessage`   | `string`                                                  | `'Loading more items.'`                         | Localizable message announced while additional items are loading.                                                                                                                                                                   |
...
| `styleClass`           | `string`                                                  | `''`                                            | Additional CSS class(es) applied to the host element.                                                                                                                                                                               |
...
| `trackByFn`            | `((index: number, item: unknown) => unknown) | undefined` | `(index: number`                                | TrackBy function forwarded to the @for item loop. Receives (absoluteIndex, item).                                                                                                                                                   |
