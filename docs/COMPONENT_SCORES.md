...
_Focus: Focus trap correctness, scroll lock, Escape handling, `aria-modal`, `role=dialog/alertdialog`, animation reduced-motion._
...
_Focus: `role=menu/menubar/menuitem`, arrow key navigation, `aria-expanded` on submenus, `aria-current` on active items._
...
_Focus: Label association, validation state announcements, group roles, indeterminate states._
...
_Focus: Grid/treegrid roles, sortable column headers, selection announcements, live regions._
...
_Focus: Live regions, icon-only button labels, landmark roles, reduced motion._
...
_Standard hardening — API, DX, theming, and polish pass. A11y concerns are minimal._
...
| Component   | API | A11y | Perf | Comp | Theme | DX  | Docs | Polish | Angular | Feel | I18n | Avg | Status |
| ----------- | --- | ---- | ---- | ---- | ----- | --- | ---- | ------ | ------- | ---- | ---- | --- | ------ |
| Card        | 9   | 9    | 9    | 9    | 9     | 9   | 9    | 9      | 9       | 9    | 9    | 9.0 | 🟢     |
...
| Component   | API | A11y | Perf | Comp | Theme | DX  | Docs | Polish | Angular | Feel | I18n | Avg | Status |
| ----------- | --- | ---- | ---- | ---- | ----- | --- | ---- | ------ | ------- | ---- | ---- | --- | ------ |
| Tabs        | 9   | 9    | 9    | 9    | 9     | 9   | 9    | 9      | 9       | 9    | 9    | 9.0 | 🟢     |
| Accordion   | 9   | 9    | 9    | 9    | 9     | 9   | 9    | 9      | 9       | 9    | 9    | 9.0 | 🟢     |
...
| Menubar     | 9   | 9    | 9    | 9    | 9     | 9   | 9    | 9      | 9       | 9    | 9    | 9.0 | 🟢     |
