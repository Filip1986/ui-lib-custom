# Timeline -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/timeline
**Queue position:** Tier 6 - Display, #71
**Generated:** 2026-05-11
**Key a11y concern:** Semantic list structure, orientation
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/timeline/README.md
3. All Timeline source files -- read every file fully before coding.
...
Use role=list with role=listitem or description list (dt/dd). Each entry needs meaningful label. Decorative connectors and dots: aria-hidden=true. Custom role may need aria-orientation.
Universal checklist:
...
Create timeline.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/timeline/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=timeline --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Timeline #71 from queued to done.
