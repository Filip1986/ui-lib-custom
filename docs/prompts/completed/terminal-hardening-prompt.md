# Terminal -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/terminal
**Queue position:** Tier 6 - Display, #70
**Generated:** 2026-05-11
**Key a11y concern:** role=log, command input labeling
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/terminal/README.md
3. All Terminal source files -- read every file fully before coding.
...
Output area: role=log (implies aria-live=polite, aria-relevant=additions). Command input: aria-label. Visual cursor: aria-hidden=true. History: navigable via ArrowUp/Down.
Universal checklist:
...
Create terminal.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/terminal/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=terminal --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Terminal #70 from queued to done.
