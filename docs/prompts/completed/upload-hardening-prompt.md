# Upload -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/upload
**Queue position:** Tier 6 - Utility, #69
**Generated:** 2026-05-11
**Key a11y concern:** Drop zone announcement, file list management
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/upload/README.md
3. All Upload source files -- read every file fully before coding.
...
File input needs label. Drop zone: role=region with aria-label (File upload area). Drag-over state: aria-live announcement. File list: role=list with labeled remove buttons per file. Upload progress: aria-live announcements.
Universal checklist:
...
Create upload.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/upload/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=upload --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Upload #69 from queued to done.
