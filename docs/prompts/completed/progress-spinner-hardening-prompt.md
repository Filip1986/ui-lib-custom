# ProgressSpinner -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/progress-spinner
**Queue position:** Tier 6 - Feedback, #56
**Generated:** 2026-05-11
**Key a11y concern:** role=status, aria-label
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/progress-spinner/README.md
3. All ProgressSpinner source files -- read every file fully before coding.
...
The spinner needs role=status (polite live region) and aria-label (e.g. Loading). SVG animation: aria-hidden=true. Verify prefers-reduced-motion disables the spin animation.
Universal checklist:
...
Create progress-spinner.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/progress-spinner/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=progress-spinner --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- ProgressSpinner #56 from queued to done.
