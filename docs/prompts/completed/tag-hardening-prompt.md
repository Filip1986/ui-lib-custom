# Tag -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/tag
**Queue position:** Tier 6 - Layout, #53
**Generated:** 2026-05-11
**Key a11y concern:** Dismissible variant aria-label
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/tag/README.md
3. All Tag source files -- read every file fully before coding.
...
Tags are inline labels. Dismissible tags with a remove button must label the button specifically (e.g. Remove Python tag). Verify aria-hidden on decorative icons.
Universal checklist:
...
Create tag.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/tag/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=tag --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Tag #53 from queued to done.
