# Chip -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/chip
**Queue position:** Tier 6 - Layout, #54
**Generated:** 2026-05-11
**Key a11y concern:** Remove button label, image alt passthrough
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/chip/README.md
3. All Chip source files -- read every file fully before coding.
...
Chip remove buttons need specific aria-labels. Avatar images inside chips need alt text. Selectable chips need aria-selected or aria-pressed.
Universal checklist:
...
Create chip.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/chip/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=chip --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Chip #54 from queued to done.
