# SplitButton -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/split-button
**Queue position:** Tier 6 - Display, #68
**Generated:** 2026-05-11
**Key a11y concern:** Dropdown trigger aria-haspopup, menu keyboard nav
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/split-button/README.md
3. All SplitButton source files -- read every file fully before coding.
...
Main button and dropdown arrow are separate. Dropdown trigger: aria-haspopup=menu and aria-expanded. Dropdown panel: role=menu with role=menuitem items. Arrow keys navigate, Escape closes and returns focus to dropdown arrow.
Universal checklist:
...
## A11y Spec (aim for 18-25 tests)
Create split-button.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/split-button/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=split-button --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- SplitButton #68 from queued to done.
