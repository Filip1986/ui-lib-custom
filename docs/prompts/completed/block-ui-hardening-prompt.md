# BlockUI -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/block-ui
**Queue position:** Tier 6 - Utility, #64
**Generated:** 2026-05-11
**Key a11y concern:** aria-busy on blocked container
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/block-ui/README.md
3. All BlockUI source files -- read every file fully before coding.
...
Blocked container: aria-busy=true and aria-disabled=true. Overlay: aria-hidden=true. Keyboard focus must NOT enter the blocked container while active.
Universal checklist:
...
Create block-ui.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/block-ui/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=block-ui --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- BlockUI #64 from queued to done.
