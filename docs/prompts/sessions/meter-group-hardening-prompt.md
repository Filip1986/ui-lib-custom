# MeterGroup -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/meter-group
**Queue position:** Tier 6 - Feedback, #57
**Generated:** 2026-05-11
**Key a11y concern:** Segment aria-label values, totals announced
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/meter-group/README.md
3. All MeterGroup source files -- read every file fully before coding.
...
Each segment: role=progressbar or role=meter with aria-valuenow/min/max and aria-label. Group: role=group with aria-label. Totals: visible text or aria-live announcement.
Universal checklist:
...
Create meter-group.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/meter-group/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=meter-group --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- MeterGroup #57 from queued to done.
