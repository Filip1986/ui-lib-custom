# ImageCompare -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/image-compare
**Queue position:** Tier 6 - Display, #67
**Generated:** 2026-05-11
**Key a11y concern:** Slider role=slider + aria-valuetext
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/image-compare/README.md
3. All ImageCompare source files -- read every file fully before coding.
...
Drag handle: role=slider, aria-valuenow (0-100), aria-valuemin=0, aria-valuemax=100, aria-valuetext (e.g. 45 percent before), aria-label, arrow key support. Both images need alt text. Verify prefers-reduced-motion.
Universal checklist:
...
## A11y Spec (aim for 15-20 tests)
Create image-compare.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/image-compare/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=image-compare --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- ImageCompare #67 from queued to done.
