# ScrollTop -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/scroll-top
**Queue position:** Tier 6 - Utility, #75
**Generated:** 2026-05-11
**Key a11y concern:** aria-label on button
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/scroll-top/README.md
3. All ScrollTop source files -- read every file fully before coding.
...
Scroll-to-top button needs aria-label=Scroll to top. When hidden: must not be focusable (tabindex=-1 or display:none). Needs :focus-visible ring.
Universal checklist:
...
Create scroll-top.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/scroll-top/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=scroll-top --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- ScrollTop #75 from queued to done.
