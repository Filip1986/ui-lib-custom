# DataView — 6-Phase Hardening Prompt
**Component:** `ui-lib-custom/data-view` · `<ui-lib-data-view>`
**Queue position:** Tier 4, #38
**Generated:** 2026-05-11
**Key a11y concern:** Sort/filter control labels, list/grid toggle announcement
## Step 1 — Files to read
1. `AI_AGENT_CONTEXT.md`, `LIBRARY_CONVENTIONS.md`, `docs/VISION.md`, `docs/COMPONENT_SCORES.md`
2. `projects/ui-lib-custom/src/lib/data-view/README.md`
3. All DataView source files.
...
The sort dropdown and filter input need aria-labels. The list/grid toggle buttons need aria-pressed. A live region should announce when the view mode changes.
...
Create or update `data-view.a11y.spec.ts`:
...
## Commands
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/data-view/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=data-view --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
Update `docs/COMPONENT_SCORES.md` → DataView #38 ✅.
