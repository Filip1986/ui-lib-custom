# Panel -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/panel
**Queue position:** Tier 6 - Layout, #60
**Generated:** 2026-05-11
**Key a11y concern:** role=region, aria-labelledby, toggle aria-expanded
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/panel/README.md
3. All Panel source files -- read every file fully before coding.
...
Panel with header: role=region with aria-labelledby pointing to header id. Collapsible toggle: aria-expanded and aria-controls. Panel header is not a button unless it IS the toggle.
Universal checklist:
...
Create panel.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/panel/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=panel --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Panel #60 from queued to done.
