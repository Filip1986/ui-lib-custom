# Toolbar -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/toolbar
**Queue position:** Tier 6 - Layout, #59
**Generated:** 2026-05-11
**Key a11y concern:** role=toolbar, aria-label
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/toolbar/README.md
3. All Toolbar source files -- read every file fully before coding.
...
Toolbar container: role=toolbar with aria-label. Arrow keys navigate between items, Tab exits. Items use roving tabindex pattern.
Universal checklist:
...
Create toolbar.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/toolbar/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=toolbar --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Toolbar #59 from queued to done.
