# Chart -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/chart
**Queue position:** Tier 6 - Display, #72
**Generated:** 2026-05-11
**Key a11y concern:** Accessible data table alternative, aria-label
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/chart/README.md
3. All Chart source files -- read every file fully before coding.
...
Minimum: (1) aria-label on canvas describing the chart; (2) visually-hidden data table with same data; (3) role=img with aria-label fallback. prefers-reduced-motion must disable all Chart.js animations.
Universal checklist:
...
Create chart.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/chart/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=chart --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Chart #72 from queued to done.
