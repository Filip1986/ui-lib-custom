# Image -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/image
**Queue position:** Tier 6 - Display, #66
**Generated:** 2026-05-11
**Key a11y concern:** Alt text, preview dialog a11y
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/image/README.md
3. All Image source files -- read every file fully before coding.
...
Images need alt text. Preview/lightbox: role=dialog, aria-modal=true, focus trap, Escape-to-close with focus restoration. Zoomable: keyboard zoom controls. See Galleria hardening for lightbox pattern.
Universal checklist:
...
Create image.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/image/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=image --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Image #66 from queued to done.
