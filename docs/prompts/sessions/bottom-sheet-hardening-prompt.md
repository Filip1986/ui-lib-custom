# BottomSheet -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/bottom-sheet
**Queue position:** Tier 6 - Overlay, #76
**Generated:** 2026-05-11
**Key a11y concern:** role=dialog, focus management
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/bottom-sheet/README.md
3. All BottomSheet source files -- read every file fully before coding.
...
Dialog variant: role=dialog, aria-modal=true, accessible name via aria-labelledby, focus trap, Escape closes with focus restoration to trigger. Backdrop: aria-hidden=true. Same pattern as Dialog hardening.
Universal checklist:
...
Create bottom-sheet.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/bottom-sheet/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=bottom-sheet --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- BottomSheet #76 from queued to done.
