# FocusTrap -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/focus-trap
**Queue position:** Tier 6 - Utility, #73
**Generated:** 2026-05-11
**Key a11y concern:** Correct sentinel node strategy
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/focus-trap/README.md
3. All FocusTrap source files -- read every file fully before coding.
...
Sentinel nodes: aria-hidden=true with tabindex=0. On activation: focus first focusable child. On deactivation: restore focus to trigger. This is foundational - must be 100% correct. Verify Tab and Shift+Tab both stay trapped.
Universal checklist:
...
Create focus-trap.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/focus-trap/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=focus-trap --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- FocusTrap #73 from queued to done.
