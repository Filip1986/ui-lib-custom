# Inplace -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/inplace
**Queue position:** Tier 6 - Utility, #63
**Generated:** 2026-05-11
**Key a11y concern:** Display/edit toggle aria-expanded
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/inplace/README.md
3. All Inplace source files -- read every file fully before coding.
...
Display element activating edit mode: should be button with aria-expanded=false. On edit activation: aria-expanded=true and focus moves to edit field. Escape/save returns focus to display element.
Universal checklist:
...
Create inplace.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/inplace/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=inplace --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Inplace #63 from queued to done.
