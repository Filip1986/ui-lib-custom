# Divider -- 6-Phase Hardening Prompt
**Component:** ui-lib-custom/divider
**Queue position:** Tier 6 - Layout, #58
**Generated:** 2026-05-11
**Key a11y concern:** role=separator + aria-orientation
## Step 1 -- Files to read
1. AI_AGENT_CONTEXT.md, LIBRARY_CONVENTIONS.md, docs/VISION.md, docs/COMPONENT_SCORES.md
2. projects/ui-lib-custom/src/lib/divider/README.md
3. All Divider source files -- read every file fully before coding.
...
Dividers: role=separator. Horizontal: aria-orientation=horizontal (default). Vertical: aria-orientation=vertical. Purely decorative: aria-hidden=true. With label text: aria-label with that text.
Universal checklist:
...
Create divider.a11y.spec.ts covering:
...
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/divider/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=divider --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
## Scoring and Handoff
Score all 10 categories using the rubric in docs/COMPONENT_SCORES.md.
Update docs/COMPONENT_SCORES.md -- Divider #58 from queued to done.
