# OrderList — 6-Phase Hardening Prompt
**Component:** `ui-lib-custom/order-list` · `<ui-lib-order-list>`
**Queue position:** Tier 4, #39
**Generated:** 2026-05-11
**Key a11y concern:** Drag-and-drop a11y keyboard alternative, reorder announcement
## Step 1 — Files to read
1. `AI_AGENT_CONTEXT.md`, `LIBRARY_CONVENTIONS.md`, `docs/VISION.md`, `docs/COMPONENT_SCORES.md`
2. `projects/ui-lib-custom/src/lib/order-list/README.md`
3. All OrderList source files.
...
Drag-and-drop is inaccessible to keyboard users — a keyboard reorder alternative is REQUIRED. Implement Move Up / Move Down buttons with aria-labels. Use a live region to announce reorder actions.
...
Create or update `order-list.a11y.spec.ts`:
...
## Commands
```bash
node_modules/.bin/eslint projects/ui-lib-custom/src/lib/order-list/ --max-warnings 0
node_modules/.bin/jest --testPathPatterns=order-list --no-coverage
node_modules/.bin/ng build ui-lib-custom
node_modules/.bin/jest --testPathPatterns=entry-points --no-coverage
```
Update `docs/COMPONENT_SCORES.md` → OrderList #39 ✅.
