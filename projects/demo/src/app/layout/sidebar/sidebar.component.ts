...
export class SidebarComponent {
  ...
  public readonly menuItems: WritableSignal<NavItem[]> = signal<NavItem[]>([
    ...
    },
    {
      ...
      expanded: false,
      items: [
        { isGroupLabel: true, label: 'Free' },
        {
          label: 'App Shell',
          icon: 'pi pi-window-maximize',
          route: '/templates/app-shell',
        },
        {
          label: 'Auth Pages',
          icon: 'pi pi-sign-in',
          route: '/templates/auth-pages',
        },
        {
          label: 'Settings Page',
          icon: 'pi pi-cog',
          route: '/templates/settings-page',
        },
        {
          label: 'Error Pages',
          icon: 'pi pi-exclamation-triangle',
          route: '/templates/error-pages',
        },
        {
          label: 'Team & Profile',
          icon: 'pi pi-users',
          route: '/templates/team-profile',
        },
        { isGroupLabel: true, label: 'Pro' },
        {
          label: 'Admin Dashboard',
          icon: 'pi pi-chart-pie',
          route: '/templates/pro-admin-dashboard',
          badge: 'SOON',
        },
        {
          label: 'SaaS App Shell',
          icon: 'pi pi-desktop',
          route: '/templates/pro-saas-shell',
          badge: 'SOON',
        },
        {
          label: 'CRM Interface',
          icon: 'pi pi-user-plus',
          route: '/templates/pro-crm',
          badge: 'SOON',
        },
        {
          label: 'E-commerce Admin',
          icon: 'pi pi-shopping-cart',
          route: '/templates/pro-ecommerce',
          badge: 'SOON',
        },
        {
          label: 'Project Board',
          icon: 'pi pi-list',
          route: '/templates/pro-project-board',
          badge: 'SOON',
        },
        {
          label: 'Landing Page Kit',
          icon: 'pi pi-globe',
          route: '/templates/pro-landing-page',
          badge: 'SOON',
        },
        {
          label: 'AI App Shell',
          icon: 'pi pi-comments',
          route: '/templates/pro-ai-shell',
          badge: 'SOON',
        },
      ],
    },
