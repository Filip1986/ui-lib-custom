...
describe('Secondary Entry Points', (): void => {
  ...
  it('should import from bottom-sheet', async (): Promise<void> => {
    const mod: typeof UiLibBottomSheet = await import('ui-lib-custom/bottom-sheet');
    expect(mod.BottomSheet).toBeDefined();
  });

  it('should import from confirm-dialog', async (): Promise<void> => {
    const mod: typeof UiLibConfirmDialog = await import('ui-lib-custom/confirm-dialog');
    expect(mod.ConfirmDialog).toBeDefined();
    expect(mod.ConfirmationService).toBeDefined();
  });

  it('should import from confirm-popup', async (): Promise<void> => {
  ...
  it('should import from tooltip', async (): Promise<void> => {
    const mod: typeof UiLibTooltip = await import('ui-lib-custom/tooltip');
  ...
  it('should import from stepper', async (): Promise<void> => {
    const mod: typeof UiLibStepper = await import('ui-lib-custom/stepper');
    expect(mod.Stepper).toBeDefined();
    expect(mod.StepperPanel).toBeDefined();
  });
  ...
  it('should import from dynamic-dialog', async (): Promise<void> => {
    const mod: typeof UiLibDynamicDialog = await import('ui-lib-custom/dynamic-dialog');
    expect(mod.DynamicDialog).toBeDefined();
