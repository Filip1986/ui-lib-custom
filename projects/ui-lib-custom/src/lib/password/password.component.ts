...
@Component({
  ...
  host: {
    ...
    '[class.ui-lib-password--filled]': 'appearance() === "filled"',
    ...
    '[class.ui-lib-password--material]': 'effectiveVariant() === "material"',
    '[class.ui-lib-password--bootstrap]': 'effectiveVariant() === "bootstrap"',
    '[class.ui-lib-password--minimal]': 'effectiveVariant() === "minimal"',
  },
})
