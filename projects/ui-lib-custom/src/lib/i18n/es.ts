...
export const UI_LIB_ES: UiLibTranslationBundle = {
  ...
  'paginator.jump.placeholder': 'Página',
  ...
  'progress-spinner.label': 'Cargando',

  // ── Tag ───────────────────────────────────────────────────────────────────
  'tag.remove': 'Eliminar etiqueta {value}',
  'tag.remove-unlabelled': 'Eliminar etiqueta',

  // ── Checkbox ─────────────────────────────────────────────────────────────
  'checkbox.label': 'Casilla de verificación',
  'checkbox.checked': 'marcado',
  'checkbox.unchecked': 'desmarcado',

  // ── ToggleSwitch ─────────────────────────────────────────────────────────
  'toggle-switch.label': 'Interruptor',
  'toggle-switch.on': 'activado',
  'toggle-switch.off': 'desactivado',
  ...
  // ── Badge ─────────────────────────────────────────────────────────────────
  'badge.status-indicator': 'Indicador de estado',
  ...
  'tree-select.placeholder': 'Seleccionar un nodo...',
  'tree-select.filter.placeholder': 'Buscar...',
  'tree-select.empty': 'No se encontraron resultados',

  // ── Table / TreeTable ─────────────────────────────────────────────────────
  'table.expand-row': 'Expansión de fila',
  'table.empty': 'No se encontraron registros.',
  'table.filter.placeholder': 'Buscar...',
  'tree-table.label': 'Tabla de árbol',
  'table.select-all': 'Seleccionar todas las filas',
  'tree-table.filter': 'Filtrar tabla',
  'tree-table.filter.placeholder': 'Buscar...',
  'tree-table.select-row': 'Seleccionar fila',
  'tree-table.select-all': 'Seleccionar todas las filas',

  // ── Tabs ──────────────────────────────────────────────────────────────────
  'tabs.close': 'Cerrar pestaña',
  'tabs.scroll.prev': 'Pestañas anteriores',
  'tabs.scroll.next': 'Pestañas siguientes',

  // ── Menubar ───────────────────────────────────────────────────────────────
  'menubar.toggle': 'Alternar menú de navegación',
  'menubar.label': 'Navegación',
  ...
  'icon-button.loading': 'Cargando, por favor espere',
  'select-button.label': 'Seleccionar una opción',
  ...
  'input-mask.incomplete': 'Por favor, complete el formato requerido.',
  'input-mask.invalid': 'El valor introducido no coincide con el formato requerido.',

  // ── KeyFilter ─────────────────────────────────────────────────────────────
  'key-filter.paste-filter':
    'Los caracteres que no coinciden con el patrón permitido fueron eliminados.',

  'password.clear': 'Limpiar contraseña',
  'password.show': 'Mostrar contraseña',
  'password.hide': 'Ocultar contraseña',
  'password.prompt': 'Introduzca una contraseña',
  'password.weak': 'Débil',
  'password.medium': 'Media',
  'password.strong': 'Fuerte',
  'password.strength.none': 'Seguridad de la contraseña: ninguna',
  'password.strength.weak': 'Seguridad de la contraseña: débil',
  'password.strength.medium': 'Seguridad de la contraseña: media',
  ...
  'tree.empty': 'No hay elementos para mostrar',
  ...
  'upload.choose': 'Elegir',
  'upload.upload': 'Cargar',
  'upload.cancel': 'Cancelar',
  'upload.empty': 'Arrastra y suelta archivos aquí para cargarlos.',

  // ── Image ─────────────────────────────────────────────────────────────────
  'image.controls': 'Controles de imagen',
  'image.preview': 'Vista previa de imagen',
  'image.error': 'Error al cargar la imagen',
  'image.zoom-in': 'Acercar',
  'image.zoom-out': 'Alejar',
  'image.rotate-left': 'Girar a la izquierda',
  'image.rotate-right': 'Girar a la derecha',
  'image.close': 'Cerrar vista previa',
  ...
  'data-view.empty': 'No se encontraron registros.',
  'data-view.filter.placeholder': 'Filtrar elementos',
  ...
  // ── Avatar ────────────────────────────────────────────────────────────────
  'skeleton.label': 'Cargando contenido',
  ...
  // ── ConfirmPopup ──────────────────────────────────────────────────────────
  'confirm-popup.message': '¿Está seguro de que desea continuar?',
  'confirm-popup.accept': 'Sí',
  'confirm-popup.reject': 'No',

  // ── SpeedDial ─────────────────────────────────────────────────────────────
  'speed-dial.trigger': 'Abrir marcación rápida',
  ...
  'code-snippet.label.file': 'Fragmento de código: {filename}',
  'code-snippet.label.multi-file': 'Fragmento de código con {count} archivos',

  // ── Accessible-name fallbacks (applied when no ariaLabel/ariaLabelledBy is set) ──
  'datepicker.input.label': 'Seleccionar fecha',
  'input-number.input.label': 'Entrada numérica',
  'cascade-select.label': 'Seleccionar',
  'tree-select.label': 'Seleccionar',
