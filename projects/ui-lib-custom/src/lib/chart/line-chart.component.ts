...
/** Typed convenience wrapper for a line chart. */
@Component({
  selector: 'ui-lib-line-chart',
  standalone: true,
...
export class LineChartComponent {
  ...
  public readonly options: InputSignal<ChartOptions<'line'> | null> =
    input<ChartOptions<'line'> | null>(null);
  ...
  /** Emits when a line chart data element is clicked. */
  public readonly chartClick: OutputEmitterRef<ChartClickEvent> = output<ChartClickEvent>();

  /** Emits when a line chart data element is hovered. */
  ...
  public getChartInstance(): Chart<'line'> | null {
    ...
    return chartInstance as Chart<'line'> | null;
  }
